...
const createLifeTouchHandlers = (lifeTouchStart, lifeTouchEnd, lifeCardIndex, setLifeTouchStart, setLifeTouchEnd, setLifeIsDragging, setLifeCardIndex) => {
...
const createFinancesTouchHandlers = (financesTouchStart, financesTouchEnd, financesCardIndex, setFinancesTouchStart, setFinancesTouchEnd, setFinancesIsDragging, setFinancesCardIndex) => {
...
const createWellnessTouchHandlers = (wellnessTouchStart, wellnessTouchEnd, wellnessCardIndex, setWellnessTouchStart, setWellnessTouchEnd, setWellnessIsDragging, setWellnessCardIndex) => {
