...
function LighthouseLogo({
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    d: "M 60 170 Q 80 165, 100 170 T 140 170",
    stroke: "#4a90e2",
    strokeWidth: "2",
    fill: "none"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M 50 175 Q 75 170, 100 175 T 150 175",
    stroke: "#4a90e2",
    strokeWidth: "2",
    fill: "none",
    opacity: "0.6"
...
function App() {
    ...
    const unsubscribe = auth.onAuthStateChanged(async firebaseUser => {
      ...
      if (firebaseUser) {
        try {
          ...
          let userDoc = await firestoreWithTimeout(db.collection('users').doc(firebaseUser.uid).get(), 10000);
          if (!userDoc.exists) {
  ...
  return user ? /*#__PURE__*/React.createElement(PIRApp, {
    user: user
...
function LoginScreen() {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Guiding Light"), /*#__PURE__*/React.createElement("p", {
    className: "app-subtitle"
  }, "Recovery Services"), /*#__PURE__*/React.createElement("form", {
    ...
    disabled: loading
  }, loading ? 'Signing in...' : 'Sign In'), error && /*#__PURE__*/React.createElement("div", {
...
const exportGraphsToPDF = async (graphDateRange, user) => {
  try {
    ...
    doc.text('Wellness Graphs Report', pageWidth / 2, 20, {
      align: 'center'
    });
    ...
    const graphsContainer = document.querySelector('.wellness-graphs-container') || document.querySelector('[style*="wellness"]') || moodCanvas.closest('div');
    if (graphsContainer) {
    ...
    doc.text('Generated with GLRS Lighthouse Recovery App', pageWidth / 2, pageHeight - 10, {
      align: 'center'
    });
