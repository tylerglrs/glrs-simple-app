...
/>
                            ...
                            <div style={{ padding: '24px', textAlign: 'center' }}>
                                ...
                                <div style={{ marginBottom: '24px' }}>
                                    ...
                                    <div style={{ fontSize: '28px', fontWeight: '700', color: '#00A86B', marginBottom: '8px' }}>
                                        ${data.actualMoneySaved.toLocaleString()}
                                    </div>
                                    <button
                                        onClick={() => {
                                ...
                                <div style={{
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                        ...
                                        <span style={{ fontSize: '13px', fontWeight: '600', color: '#00A86B' }}>${data.actualMoneySaved.toLocaleString()}</span>
                                    </div>
                                </div>
                        ...
                        <div style={{ padding: '20px' }}>
                            ...
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    {data.patternDetection.message}
                                </div>
                                {data.patternDetection.day && (
                                    <div style={{
                                        fontSize: '14px',
                                        fontWeight: '400',
                                        color: '#666666'
                                    }}>
                                        Day: {data.patternDetection.day} | Value: {data.patternDetection.value}
                                    </div>
                                )}
                            </div>
                            ...
                            <div style={{ marginBottom: '20px' }}>
                                {data.patternDetection.tips.map((tip, index) => (
                                    <div key={index} style={{
                                        background: '#F5F5F5',
                                        borderRadius: '8px',
                                        padding: '12px',
                    ...
                    <>
                        {data.nextMilestone && (
                            ...
                            <div style={{
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px' }}>
                                    <i data-lucide={data.nextMilestone.icon} style={{ width: '32px', height: '32px' }}></i>
                                    <div>
                                        <div style={{ fontSize: '16px', fontWeight: 'bold' }}>
                                            {data.nextMilestone.achieved ?
                                        ...
                                        <div style={{ fontSize: '14px', opacity: 0.9 }}>
                                            {data.nextMilestone.achieved ?
                                                `${data.nextMilestone.daysSober} days sober` :
                                                `${data.nextMilestone.daysUntil} ${data.nextMilestone.daysUntil === 1 ? 'day' : 'days'} to go`
                                            }
                                        </div>
                                    </div>
                                </div>
                                {!nextMilestone.achieved && (
                                    <>
                                        ...
                                        <div style={{ fontSize: '12px', textAlign: 'right', opacity: 0.9 }}>
                                            {data.nextMilestone.progressPercentage}% complete
                                        </div>
                                    </>
                                )}
                            </div>
            ...
            <div style={{ padding: '20px' }}>
                ...
                <div style={{ marginBottom: '20px' }}>
                    ...
                    <div style={{
                        ...
                        {data.gratitudeThemes.map(theme => (
                            <button
                                key={theme.id}
                                onClick={() => {
                                    data.triggerHaptic('light');
            ...
            <div style={{ padding: '20px' }}>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        {data.checkInStreak} {checkInStreak === 1 ? 'Day' : 'Days'}
                    </div>
                    <div style={{
                        fontSize: '14px',
                        fontWeight: '400',
                        ...
                        return (
                            ...
                            >
                                <div style={{
                                    ...
                                    Day {data.data.streakCheckIns.length - index} - {dateStr}
                                </div>
                                <div style={{
                                    fontSize: '12px',
                                    fontWeight: '400',
            ...
            <div style={{ padding: '20px' }}>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        {data.reflectionStreak} {reflectionStreak === 1 ? 'Day' : 'Days'}
                    </div>
                    <div style={{
                        fontSize: '14px',
                        fontWeight: '400',
                            ...
                            >
                                <div style={{
                                    ...
                                    <div style={{
                                        ...
                                        Day {data.streakReflections.length - index} - {dateStr}
                                    </div>
                                    {hasGratitude && (
            ...
            <div style={{ padding: '20px' }}>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        {data.moodWeekData.difference > 0 ? '↑' : moodWeekData.difference < 0 ? '↓' : '—'} {data.moodWeekData.difference > 0 ? '+' : ''}{data.moodWeekData.difference || '0'} from last week
                    </div>
                </div>
            ...
            <div style={{ padding: '20px' }}>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        {data.overallDayWeekData.thisWeekAvg || '—'}
                    </div>
                    <div style={{
                        fontSize: '14px',
                        fontWeight: '400',
                        ...
                        {data.overallDayWeekData.difference > 0 ? '↑' : overallDayWeekData.difference < 0 ? '↓' : '—'} {data.overallDayWeekData.difference > 0 ? '+' : ''}{data.overallDayWeekData.difference || '0'} from last week
                    </div>
                </div>
    ...
    onClick={() => onClose()}>
        ...
        onClick={(e) => e.stopPropagation()}>
            ...
            <div style={{ padding: '20px' }}>
                ...
                {/* Themes List */}
                {data.reflectionStats.gratitudeThemes && data.reflectionStats.gratitudeThemes.length > 0 ? (
                    <div style={{ marginBottom: '20px' }}>
    ...
    onClick={() => {
        ...
        onClick={(e) => e.stopPropagation()}>
            ...
            <div style={{ padding: '20px', overflowY: 'auto', flex: 1 }}>
                ...
                {data.gratitudeInsights && data.gratitudeInsights.computed && (
                    <div style={{
                        ...
                        {data.gratitudeInsights.computed.topThemes && data.gratitudeInsights.computed.topThemes.length > 0 && (
                            <div style={{ marginBottom: '16px' }}>
                                <div style={{
                                    fontSize: '13px',
                                    fontWeight: '600',
                                ...
                                <div style={{
                                    ...
                                    {data.gratitudeInsights.computed.topThemes.slice(0, 3).map((theme, idx) => (
                                        <div key={idx} style={{
                                            background: 'rgba(255, 255, 255, 0.2)',
                                            padding: '8px 14px',
                                            borderRadius: '20px',
                        ...
                        {data.gratitudeInsights.computed.gaps && data.gratitudeInsights.computed.gaps.length > 0 && (
                            <div style={{ marginBottom: '16px' }}>
                                <div style={{
                                    fontSize: '13px',
                                    fontWeight: '600',
                                ...
                                <div style={{
                                    ...
                                    {data.gratitudeInsights.computed.gaps[0].severity === 'high' ? (
                                        <span>Consider reflecting on <strong>{data.gratitudeInsights.computed.gaps[0].category}</strong> - it's been {data.gratitudeInsights.computed.gaps[0].daysSinceLast} days since your last mention.</span>
                                    ) : (
                                        <span>You might explore gratitude for <strong>{data.gratitudeInsights.computed.gaps[0].category}</strong> to deepen your practice.</span>
                                    )}
                                </div>
                            </div>
                        )}
                        ...
                        {data.gratitudeInsights.computed.lastComputed && (
                            <div style={{
                                fontSize: '11px',
                                opacity: 0.7,
                                marginTop: '12px'
                            }}>
                                Insights updated {new Date(data.gratitudeInsights.computed.lastComputed.toDate()).toLocaleDateString()}
                            </div>
                        )}
                    </div>
                )}
                ...
                {data.gratitudeJournalData.length > 0 ? (
                    <div style={{ marginBottom: '20px' }}>
                        {data.gratitudeJournalData.map((entry, index) => (
    ...
    onClick={() => {
        ...
        onClick={(e) => e.stopPropagation()}>
            ...
            <div style={{ padding: '20px', overflowY: 'auto', flex: 1 }}>
                ...
                {data.challengesInsights && data.challengesInsights.categories && Object.keys(data.challengesInsights.categories).length > 0 && (
                    <div style={{
                        marginBottom: '24px',
                        padding: '20px',
                        ...
                        <div style={{
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                {Object.entries(data.challengesInsights.categories)
                            ...
                            {data.challengesInsights.totalChallenges && (
                                <div style={{
                                    marginTop: '16px',
                                    padding: '12px',
                ...
                {/* Challenges List */}
                {data.challengesHistoryData.length > 0 ? (
                    <div style={{ marginBottom: '20px' }}>
                        {data.challengesHistoryData.map((entry, index) => (
                            <div key={entry.id} style={{
                                marginBottom: '16px',
                                padding: '16px',
                                background: '#FFF3CD',
            ...
            <div style={{ padding: '20px', overflowY: 'auto', flex: 1 }}>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        {data.selectedChallenge.challengeText}
                    </div>
                </div>
                    ...
                    <div style={{
                        ...
                        {[
                            ...
                            >
                                ...
                                {data.challengeCheckInStatus === status.value && (
                ...
                <div style={{ marginBottom: '20px' }}>
                    ...
                    <textarea
                        ...
                        placeholder={
                            data.challengeCheckInStatus === 'resolved' ? 'What helped you overcome this challenge?' :
                            data.challengeCheckInStatus === 'better' ? 'What strategies are working for you?' :
                            data.challengeCheckInStatus === 'worse' ? 'What is making this harder right now?' :
                            data.challengeCheckInStatus === 'help' ? 'What kind of support do you need?' :
                ...
                >
                    {data.challengeCheckInStatus === 'resolved' ? '🎉 Mark as Resolved' : '✅ Save Check-In'}
                </button>
    ...
    onClick={() => {
        ...
        onClick={(e) => e.stopPropagation()}>
            ...
            {/* Challenge Text */}
            {data.breakthroughData.challengeText && (
                <div style={{
                    padding: '20px',
                    background: 'rgba(255, 255, 255, 0.15)',
                    borderRadius: '16px',
            ...
            {data.breakthroughData.daysSinceLastMention && (
                <div style={{
                    padding: '16px',
                    background: 'rgba(255, 255, 255, 0.2)',
                    borderRadius: '12px',
                    ...
                    <>
                        ...
                        <div style={{ marginBottom: '20px' }}>
                            ...
                            <textarea
                                ...
                                placeholder={
                                    data.goalStatus === 'yes' ? 'What helped you succeed?' :
                                    data.goalStatus === 'almost' ? 'What got in the way?' :
                                    data.goalStatus === 'no' ? 'What prevented you from completing it?' :
                        ...
                        {data.goalStats.totalGoals > 0 ? (
                            <>
                                ...
                                <h4 style={{
                                    ...
                                    Recent Goals ({data.goalStats.totalGoals} total)
                                </h4>

                                <div style={{ marginBottom: '20px' }}>
                                    {data.goalHistory.slice(0, 10).map((goal, index) => (
    ...
    <div style={{
        ...
        <div style={{
            ...
            <div style={{ padding: '20px' }}>
                ...
                {data.streakData.currentStreak > 0 && (
                    <div style={{
                        ...
                        <div style={{ fontSize: '32px', fontWeight: 'bold', color: '#058585' }}>
                            🔥 {data.streakData.currentStreak} {data.streakData.currentStreak === 1 ? 'day' : 'days'}
                        </div>
                ...
                {data.streakData.allStreaks.length > 0 ? (
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
    ...
    <div style={{
        ...
        <div style={{
            ...
            <div style={{ padding: '20px' }}>
                {/* Current Streak */}
                {data.reflectionStreakData.currentStreak > 0 && (
                    <div style={{
                        padding: '16px',
                        background: 'linear-gradient(135deg, rgba(5, 133, 133, 0.1) 0%, rgba(0, 168, 107, 0.1) 100%)',
                        borderRadius: '12px',
                        ...
                        <div style={{ fontSize: '32px', fontWeight: 'bold', color: '#058585' }}>
                            🔥 {data.reflectionStreakData.currentStreak} {data.reflectionStreakData.currentStreak === 1 ? 'day' : 'days'}
                        </div>
                        <div style={{ fontSize: '12px', color: '#666', marginTop: '8px' }}>
                ...
                {data.reflectionStreakData.allStreaks.length > 0 ? (
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '8px', marginBottom: '16px' }}>
                        <button
                            onClick={() => {
                                ...
                                handlers.setGraphDateRange({ start: startDate, end: endDate });
                                handlers.setSelectedRange('7days');
                            }}
                            style={{
                                padding: '12px',
                                background: data.selectedRange === '7days' ?
                        ...
                        <button
                            ...
                            style={{
                                padding: '12px',
                                background: data.selectedRange === '30days' ?
                                    'linear-gradient(135deg, #00A86B 0%, #008554 100%)' : '#F5F5F5',
                        ...
                        <button
                            ...
                            style={{
                                padding: '12px',
                                background: data.selectedRange === '90days' ?
                                    'linear-gradient(135deg, #00A86B 0%, #008554 100%)' : '#F5F5F5',
                        ...
                        <button
                            onClick={() => {
                                data.triggerHaptic('light');
                                handlers.setGraphDateRange({ start: null, end: null });
                                handlers.setSelectedRange('all');
                            }}
                            style={{
                                padding: '12px',
                                background: data.selectedRange === 'all' ?
                                    'linear-gradient(135deg, #00A86B 0%, #008554 100%)' : '#F5F5F5',
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) => {
                                        ...
                                        handlers.setGraphDateRange({ ...graphDateRange, start: date });
                                    }}
                                    style={{
                                        width: '100%',
                                        padding: '10px',
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) => {
                                        const date = e.target.value ? new Date(e.target.value) : null;
                                        handlers.setGraphDateRange({ ...graphDateRange, end: date });
                                    }}
                                    style={{
                                        width: '100%',
                                        padding: '10px',
