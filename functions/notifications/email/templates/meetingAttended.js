// Meeting Attended Email Template
// Sent when user checks in to a meeting
// Variables: {{userName}}, {{meetingName}}, {{meetingDate}}, {{journeyUrl}}, {{unsubscribeLink}}
...
<head>
  ...
  <title>Meeting Attendance Recorded</title>
</head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="background: linear-gradient(135deg, #059669 0%, #047857 100%); padding: 30px; text-align: center;">
              ...
              <p style="color: rgba(255,255,255,0.9); margin: 10px 0 0; font-size: 16px;">Attendance Recorded</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 30px;">
              ...
              <div style="background: #ecfdf5; border-left: 4px solid #059669; padding: 20px; margin: 20px 0; border-radius: 0 8px 8px 0;">
                <h3 style="margin: 0; color: #065f46; font-size: 18px;">{{meetingName}}</h3>
                <p style="margin: 8px 0 0; color: #047857; font-size: 14px;">{{meetingDate}}</p>
              </div>

              <p style="margin: 20px 0 0; font-size: 16px; line-height: 1.6; color: #374151;">
                Every meeting you attend strengthens your recovery. Keep showing up for yourself - you're doing amazing!
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 20px; text-align: center; background: #f9fafb; border-top: 1px solid #e5e7eb;">
              <p style="margin: 0; font-size: 13px; color: #6b7280;">You're receiving this because you have attendance notifications enabled.</p>
