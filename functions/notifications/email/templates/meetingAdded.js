// Meeting Added Email Template
// Sent when new meeting(s) are added to calendar
// Variables: {{userName}}, {{meetingSummary}}, {{meetingDetails}}, {{meetingsUrl}}, {{unsubscribeLink}}
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="background: linear-gradient(135deg, #3b82f6 0%, #1d4ed8 100%); padding: 30px; text-align: center;">
              <h1 style="color: white; margin: 0; font-size: 26px; font-weight: 700;">Meeting Added</h1>
              <p style="color: rgba(255,255,255,0.9); margin: 10px 0 0; font-size: 16px;">New event on your calendar</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 30px;">
              ...
              <p style="margin: 20px 0 0; font-size: 16px; line-height: 1.6; color: #374151;">
                We'll send you reminders before the meeting. Keep up the great work on your recovery journey!
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 20px; text-align: center; background: #f9fafb; border-top: 1px solid #e5e7eb;">
              <p style="margin: 0; font-size: 13px; color: #6b7280;">You're receiving this because you have meeting notifications enabled.</p>
