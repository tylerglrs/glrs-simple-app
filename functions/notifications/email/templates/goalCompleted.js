// Goal Completed Email Template
// Sent when user completes a custom goal
// Variables: {{userName}}, {{goalTitle}}, {{goalCategory}}, {{journeyUrl}}, {{unsubscribeLink}}
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="background: linear-gradient(135deg, #059669 0%, #047857 100%); padding: 30px; text-align: center;">
              ...
              <p style="color: rgba(255,255,255,0.9); margin: 10px 0 0; font-size: 16px;">Another win for your recovery</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 30px; text-align: center; border-bottom: 1px solid #e5e7eb;">
              <div style="background: linear-gradient(135deg, #fbbf24 0%, #f59e0b 100%); border-radius: 50%; width: 100px; height: 100px; display: inline-block; line-height: 100px;">
          ...
          <tr>
            <td style="padding: 30px;">
              ...
              <div style="background: #ecfdf5; border-left: 4px solid #059669; padding: 20px; margin: 20px 0; border-radius: 0 8px 8px 0;">
                <h3 style="margin: 0; color: #065f46; font-size: 20px;">{{goalTitle}}</h3>
                <p style="margin: 8px 0 0; color: #047857; font-size: 14px;">Category: {{goalCategory}}</p>
                <p style="margin: 8px 0 0; color: #059669; font-size: 14px; font-weight: 600;">100% Complete!</p>
              </div>

              <p style="margin: 20px 0 0; font-size: 16px; line-height: 1.6; color: #374151;">
                Setting and achieving goals is a powerful part of recovery. Each goal you complete builds momentum and confidence for the journey ahead.
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 0 30px 30px;">
              <div style="background: #f0fdf4; border-radius: 8px; padding: 20px;">
                <p style="margin: 0; color: #166534; font-size: 16px; font-weight: 600;">What's next?</p>
                <p style="margin: 10px 0 0; color: #15803d; font-size: 14px;">Consider setting a new goal to continue your progress. Small steps lead to big changes!</p>
              </div>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 20px; text-align: center; background: #f9fafb; border-top: 1px solid #e5e7eb;">
              <p style="margin: 0; font-size: 13px; color: #6b7280;">You're receiving this because you have goal completion notifications enabled.</p>
