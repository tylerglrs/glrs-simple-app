...
function PIRApp({ user }) {
    ...
    }, [currentView, showModal, showGratitudeJournalModal, showChallengesHistoryModal, showTomorrowGoalsModal, showChallengeCheckInModal, showBreakthroughModal, showIncompleteTasksModal, showSidebar, showHabitTrackerModal, showQuickReflectionModal, showThisWeekTasksModal, showOverdueItemsModal, showMarkCompleteModal, showProgressStatsModal, showGoalProgressModal, showTodayWinsModal, showHabitHistory, showReflectionHistory, showWinsHistory, lifeCardIndex]);
    ...
    useEffect(() => {
        if (showSetGoalModal || showJarModal || showAddCountdownModal || showUpdateAmountModal) {
    ...
    }, [showSetGoalModal, showJarModal, showAddCountdownModal, showUpdateAmountModal]);
...
const app = {
    ...
    showSetGoalModal, setShowSetGoalModal,
    showJarModal, setShowJarModal,
    customGoalItems, setCustomGoalItems,
    showAddCountdownModal, setShowAddCountdownModal,
    showUpdateAmountModal, setShowUpdateAmountModal,
    tempAmount, setTempAmount,
    ...
    // ========================================
    // PATTERN/INSIGHTS MODAL STATES (9 states × 2 = 18 properties)
    // ========================================
    showTipsModal, setShowTipsModal,
    showMoodPatternModal, setShowMoodPatternModal,
    showCravingPatternModal, setShowCravingPatternModal,
    showAnxietyPatternModal, setShowAnxietyPatternModal,
    showSleepPatternModal, setShowSleepPatternModal,
    showMoodInsightsModal, setShowMoodInsightsModal,
    showOverallDayInsightsModal, setShowOverallDayInsightsModal,
    moodWeekData, setMoodWeekData,
    overallDayWeekData, setOverallDayWeekData,

    // ========================================
    // STREAK MODAL STATES (8 states × 2 = 16 properties)
    // ========================================
    ...
    // ========================================
    // CALENDAR/MILESTONE MODAL STATES (9 states × 2 = 18 properties)
    // ========================================
    showCalendarHeatmapModal, setShowCalendarHeatmapModal,
    ...
    // ========================================
    // REFLECTION MODAL STATES (5 states × 2 = 10 properties)
    // ========================================
    ...
    // ========================================
    // GRATITUDE MODAL STATES (8 states × 2 = 16 properties)
    // ========================================
    ...
    showGratitudeJournalModal, setShowGratitudeJournalModal,
    ...
    // ========================================
    // CHALLENGES MODAL STATES (7 states × 2 = 14 properties)
    // ========================================
    showChallengesHistoryModal, setShowChallengesHistoryModal,
    challengesHistoryData, setChallengesHistoryData,
    challengesInsights, setChallengesInsights,
    showChallengeCheckInModal, setShowChallengeCheckInModal,
    ...
    // ========================================
    // GRAPH/CHART MODAL STATES (3 states × 2 = 6 properties)
    // ========================================
    showGraphSettingsModal, setShowGraphSettingsModal,
    graphDateRange, setGraphDateRange,
    selectedRange, setSelectedRange,

    // ========================================
    // BREAKTHROUGH/GOALS MODAL STATES (7 states × 2 = 14 properties)
    // ========================================
    showBreakthroughModal, setShowBreakthroughModal,
    breakthroughData, setBreakthroughData,
    showTomorrowGoalsModal, setShowTomorrowGoalsModal,
    ...
    // ========================================
    // WEEKLY REPORT STATES (2 states × 2 = 4 properties)
    // ========================================
...
// Log app object properties count for verification
console.log('✅ App object created with', Object.keys(app).length, 'properties');
