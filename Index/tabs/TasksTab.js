...
function TasksTab() {
    ...
    const handleAssignmentComplete = async (assignmentId) => {
        ...
        try {
            ...
            // Reload assignments
            if (window.GLRSApp?.loaders?.loadAssignments) {
                const updatedAssignments = await window.GLRSApp.loaders.loadAssignments();
        ...
        <>
            ...
            <div style={{
                ...
                <div style={{
                        ...
                        <button
                            onClick={async () => {
                                ...
                                try {
                                    ...
                                    await window.GLRSApp.loaders.loadStreak();
                                    await window.GLRSApp.loaders.loadCheckIns();
                                    await window.GLRSApp.loaders.loadStreakCheckIns();
                                    await window.GLRSApp.loaders.loadDailyTasksStatus();
                    ...
                    onClick={async () => {
                        window.GLRSApp.utils.triggerHaptic('light');
                        await window.GLRSApp.loaders.loadMoodWeekData();
                        // TODO: Global modal - needs PIRapp prop
                    }}>
                        <span style={{
                            fontSize: '14px',
...
{/* REFLECTIONS TAB */}
                {activeTaskTab === 'reflections' && (
                    <div style={{
                        ...
                        onClick={async () => {
                            window.GLRSApp.utils.triggerHaptic('light');
                            await window.GLRSApp.loaders.loadStreakReflections();
                            // TODO: Global modal - needs PIRapp prop
                        }}>
                            <span style={{
                                fontSize: '14px',
                        ...
                        onClick={async () => {
                            window.GLRSApp.utils.triggerHaptic('light');
                            await window.GLRSApp.loaders.loadOverallDayWeekData();
                            // TODO: Global modal - needs PIRapp prop
                        }}>
                            <span style={{
                                fontSize: '14px',
                        ...
                        onClick={async () => {
                            window.GLRSApp.utils.triggerHaptic('light');
                            await window.GLRSApp.loaders.loadGratitudeJournal();
                            await window.GLRSApp.loaders.loadGratitudeInsights();
                        ...
                        onClick={async () => {
                            window.GLRSApp.utils.triggerHaptic('light');
                            await window.GLRSApp.loaders.loadChallengesHistory();
                            await window.GLRSApp.loaders.loadChallengesInsights();
                        ...
                        onClick={async () => {
                            window.GLRSApp.utils.triggerHaptic('light');
                            await window.GLRSApp.loaders.loadGoalAchievementData();
