...
function GoalsTasksView({ user, goals, assignments, onAssignmentComplete, onReflectionSave, onShowGratitudeModal, onDueTodayChange }) {
...
console.log('✅ GoalsTasksView component loaded');