/**
 * GLRS Document Template System - Shared Block Styles
 *
 * SINGLE SOURCE OF TRUTH for all block rendering styles.
 * This file is imported by both templates.html (editor) and sign.html (viewer)
 * to ensure WYSIWYG consistency.
 *
 * DO NOT duplicate these styles elsewhere. Always reference window.GLRS_STYLES.
 *
...
(function() {
    ...
    // Design tokens (colors) - matches DESIGN object in both files
    const COLORS = {
        primary: '#0077CC',
        primaryDark: '#005A9C',
        success: '#10B981',
    ...
    // Typography settings (aligned with document-constants.js)
    const TYPOGRAPHY = {
        baseFontSize: 14,
        lineHeight: 1.7,
    ...
    /**
     * Section block style
     * @param {Object} options - { index, number }
     */
    function getSectionStyle(options = {}) {
     ...
     */
    function getHeadingStyle(level = 3) {
     ...
     * @param {Object} options - { type, isCompleted, borderColor }
     */
    function getSignatureBoxStyle(options = {}) {
     ...
     * @param {Object} options - { isEditable }
     */
    function getInputStyle(options = {}) {
     ...
     * @param {Object} options - { isChecked, borderColor }
     */
    function getCheckboxStyle(options = {}) {
     ...
     * @param {Object} options - { bgLight, color }
     */
    function getRoleBadgeStyle(options = {}) {
     ...
     * @param {Object} options - { borderColor, bgLight, isEditable }
     */
    function getFieldWrapperStyle(options = {}) {
     ...
     * @param {Object} options - { isSelected, isDragging, previewMode }
     */
    function getCanvasBlockStyle(options = {}) {
     ...
     */
    const BLOCK_TYPE_INDICATOR_STYLE = {
        position: 'absolute',
        top: '4px',
        right: '4px',
        fontSize: '10px',
    ...
    /**
     * Page header style
     * @param {number} headerHeight - from GLRS_DOC.HEADER_HEIGHT
     */
    function getPageHeaderStyle(headerHeight = 70) {
        return {
            container: {
                display: 'flex',
    ...
    /**
     * Page footer style
     * @param {number} footerHeight - from GLRS_DOC.FOOTER_HEIGHT
     */
    function getPageFooterStyle(footerHeight = 50) {
        return {
            container: {
                display: 'flex',
                justifyContent: 'space-between',
     ...
     */
    function getBlockStyles(blockType, options = {}) {
        switch (blockType) {
            case 'section':
                return getSectionStyle(options);
            case 'heading':
                return getHeadingStyle(options.level);
            case 'paragraph':
            ...
            case 'acknowledgment':
                return {
                    checkbox: getCheckboxStyle(options),
                    label: FIELD_LABEL_STYLE
                };
            case 'dropdownField':
                return {
    ...
    window.GLRS_STYLES = {
        ...
        BULLET_LIST_STYLES: BULLET_LIST_STYLES,
        ...
        getSignatureBoxStyle: getSignatureBoxStyle,
        getInputStyle: getInputStyle,
        getCheckboxStyle: getCheckboxStyle,
        getRoleBadgeStyle: getRoleBadgeStyle,
        getFieldWrapperStyle: getFieldWrapperStyle,

        // Editor-specific styles
        getCanvasBlockStyle: getCanvasBlockStyle,
        BLOCK_TYPE_INDICATOR_STYLE: BLOCK_TYPE_INDICATOR_STYLE,
        DELETE_BUTTON_STYLE: DELETE_BUTTON_STYLE,

        // Header/Footer styles
        getPageHeaderStyle: getPageHeaderStyle,
        getPageFooterStyle: getPageFooterStyle,
    ...
    Object.freeze(window.GLRS_STYLES);
    Object.freeze(window.GLRS_STYLES.COLORS);
    Object.freeze(window.GLRS_STYLES.TYPOGRAPHY);
    Object.freeze(window.GLRS_STYLES.HEADING_STYLES);
    Object.freeze(window.GLRS_STYLES.PARAGRAPH_STYLE);
    Object.freeze(window.GLRS_STYLES.BULLET_LIST_STYLES);
    Object.freeze(window.GLRS_STYLES.DIVIDER_STYLE);
    Object.freeze(window.GLRS_STYLES.PAGE_BREAK_STYLE);
    Object.freeze(window.GLRS_STYLES.FIELD_LABEL_STYLE);
    Object.freeze(window.GLRS_STYLES.REQUIRED_STYLE);
    Object.freeze(window.GLRS_STYLES.PLACEHOLDER_STYLE);
    Object.freeze(window.GLRS_STYLES.BLOCK_TYPE_INDICATOR_STYLE);
    Object.freeze(window.GLRS_STYLES.DELETE_BUTTON_STYLE);

    console.log('[GLRS_STYLES] Block styles loaded:', {
        contentBlocks: ['section', 'heading', 'paragraph', 'bulletList', 'divider', 'pageBreak'],
        fieldBlocks: ['signatureField', 'initialsField', 'dateField', 'textInputField', 'checkboxField', 'dropdownField'],
